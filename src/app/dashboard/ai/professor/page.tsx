...
import FilmProfessor from "@/components/ai/FilmProfessor";

export default function FilmProfessorPage() {
  return (
    <div className="max-w-6xl mx-auto px-4 py-8 space-y-8 min-h-screen">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-2 ml-2">
          ...
          <h1 className="text-lg font-black text-white tracking-tight">Professor Classroom</h1>
        </div>
      </div>
